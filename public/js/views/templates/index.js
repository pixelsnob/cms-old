...
buf.push("</ul></nav><form name=\"search_form\" action=\"/search\" method=\"post\"><input" + (jade.attrs({ terse: true, 'type':("text"), 'name':("search"), 'value':("" + (search) + ""), 'placeholder':("Product Search...") }, {"type":true,"name":true,"value":true,"placeholder":true})) + "><input type=\"submit\" value=\"Search\"></form></header><div id=\"content\"><ul class=\"products\"></ul></div><footer></footer></body></html>");;return buf.join("");
};
});
