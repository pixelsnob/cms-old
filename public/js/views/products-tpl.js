...
var buf = [];
var locals_ = (locals || {}),title = locals_.title,settings = locals_.settings,nav = locals_.nav,search = locals_.search,products = locals_.products;buf.push("<!DOCTYPE html><html><head><title>" + (jade.escape(null == (jade.interp = title) ? "" : jade.interp)) + "</title><link rel=\"stylesheet\" href=\"/bower_components/normalize-css/normalize.css\"><link rel=\"stylesheet\" href=\"/css/main.css\">");
...
buf.push("</ul></nav><form name=\"search_form\" action=\"/search\" method=\"post\"><input" + (jade.attrs({ terse: true, 'type':("text"), 'name':("search"), 'value':("" + (search) + ""), 'placeholder':("Product Search...") }, {"type":true,"name":true,"value":true,"placeholder":true})) + "><input type=\"submit\" value=\"Search\"></form></header><div id=\"content\">");
if ( products.length)
{
buf.push("<ul class=\"products\">");
// iterate products
;(function(){
  var $$obj = products;
  if ('number' == typeof $$obj.length) {
...
buf.push("<li>" + (jade.escape(null == (jade.interp = product.description) ? "" : jade.interp)) + "</li>");
    }
...
{
buf.push("<div>No products!</div>");
}
buf.push("</div><footer></footer></body></html>");;return buf.join("");
}